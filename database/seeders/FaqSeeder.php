    ...
    public function run(): void
    {
        Faq::insert([
            ...
            [
                ...
                "answer" => "<p>Skor TOEFL berlaku selama dua tahun sejak hari hasil dikeluarkan. Jika seorang siswa ingin membuktikan kelayakan mereka setelah dua tahun, mereka harus mengikuti ujian kembali.</p>"
            ],
            [
                ...
                "answer" => "<p>Siswa yang lebih suka mengikuti tes di rumah daripada pergi ke pusat tes dapat mengikuti TOEFL iBT. Konten tes serupa dengan format pena-dan-kertas, dan kandidat akan diawasi oleh pengawas manusia secara online melalui Proctor.</p>"
            ],
            [
