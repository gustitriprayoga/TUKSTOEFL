<template>
    <Head>
        <title>{{ $page.props.app_name }} - Login</title>
    </Head>
                                    ...
                                    <div class="p-5">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <p class="text-muted">
                                                ...
                                                <a :href="`https://wa.me/${$page.props.app_whatsapp}?text=${encodeURI('Hallo, Admin. saya ingin bertanya....')}`" target="_blank">Klik Untuk Menghubungi Admin</a>
                                            </p>
                                        </div>
                                    </div>
                                </form>
