<template>
    <Head>
        <title>{{ $page.props.app_name }} - Forgot Password</title>
    </Head>
                                ...
                                <form @submit.prevent="submit" class="row g-3">
                                    <div class="p-5">
                                        ...
                                        <div class="text-center">
                                            <br>
                                            <p class="text-muted">
                                                Nomor tidak terdaftar, <a :href="`https://wa.me/${$page.props.app_whatsapp}?text=${encodeURI('Hallo, Admin saya sudah daftar dan ingin reset password, ketika konfirmasi nomor tidak terdaftar, berikut data saya untuk perbaikan:\n\nNama:\nEmail:\nNomor Handphone Aktif:\n\n terimakasih.')}`" target="_blank">klik disini</a> untuk perbaikan
                                            </p>
                                        </div>
                                    </div>
                                </form>
