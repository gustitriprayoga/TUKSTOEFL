<template>
    <Head>
        <title>{{ $page.props.app_name }} - Dashboard</title>
    </Head>
    <!--start page wrapper -->
        ...
        <div class="page-content">
                    ...
                    <div class="card radius-10 border-start border-0 border-3 border-info">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div>
                                    <p class="mb-0 text-secondary">Latihan Soal Bulan Ini</p>
            ...
            <div class="card radius-10 border-start border-0 border-3 border-primary">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div>
                            <h6 class="mb-3">Summary Latihan Terakhir</h6>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <table class="table mb-0">
                            ...
                            <tbody>
                                <tr v-if="!gradeSummaries.length">
                                    <td colspan="7" align="center">Tidak ada riwayat latihan soal</td>
                                </tr>
