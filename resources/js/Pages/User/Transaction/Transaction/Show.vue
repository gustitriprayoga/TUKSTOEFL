<template>
    <Head>
        <title>{{ $page.props.app_name }} - Detail Transaksi</title>
    </Head>
    <!--start page wrapper -->
								...
								<main>
									...
									<div class="notices">
										...
										<div class="notice">
                                            ...
                                            Setelah melakukan pembayaran, silakan lakukan konfirmasi melalui Whatsapp di <b>{{ $page.props.app_whatsapp_invoice }}</b> dengan menyertakan nomor faktur serta bukti transfer pembayaran. terimakasih
                                        </div>
									</div>
                                    <h5>
                                    </h5>
