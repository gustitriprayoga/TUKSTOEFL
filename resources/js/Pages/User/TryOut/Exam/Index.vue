<template>
    <Head>
        <title>{{ $page.props.app_name }} - Soal</title>
    </Head>
    <!--start page wrapper -->
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <!--end breadcrumb-->
            <h4 class="mb-0 text-uppercase text-center">Pilih Soal Try Out Yang Akan Anda Kerjakan....</h4>
            <hr/>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3" v-for="(exam, index) in exams.data" :key="index">
                    <div class="card border-bottom border-3 border-0">
                        <img  v-bind:src="'/storage/upload_files/categories/' + exam.category.thumbnail" class="card-img-top"/>
                        <div class="card-body">
