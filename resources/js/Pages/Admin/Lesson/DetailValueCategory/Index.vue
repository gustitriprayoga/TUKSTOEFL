<template>
    <Head>
        <title>{{ $page.props.app_name }} - Data Kategori Penilaian</title>
    </Head>
    <!--start page wrapper -->
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-lg-flex align-items-center mb-4 gap-3">
                        ...
                        <div class="ms-auto">
                            <Link :href="`/admin/value-categories/${valueCategory.id}/detail-value-categories/create`" class="btn btn-primary mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i> Tambah Kategori Penilaian</Link>
                        </div>
                    </div>
