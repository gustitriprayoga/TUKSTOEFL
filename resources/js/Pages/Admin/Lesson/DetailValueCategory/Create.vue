<template>
    <Head>
        <title>{{ $page.props.app_name }} - Tambah Detail Kategori Penilaian</title>
    </Head>
    <!--start page wrapper -->
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-lg-flex align-items-center">
                        <div class="ms-auto">
                            <Link :href="`/admin/value-categories/${valueCategory.id}/detail-value-categories`" class="btn btn-primary mt-2 mt-lg-0">Kembali</Link>
                        </div>
                    </div>
