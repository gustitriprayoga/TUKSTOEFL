                    ...
                    <div class="table-responsive">
                        <table class="table mb-0">
                            <tbody>
                                ...
                                <tr>
                                    <th>Tampilkan Koreksi Jawaban</th>
                                    <td>:</td>
                                    <td>{{ questionTitle.show_answer == 1 ? 'Ya' : 'Tidak' }}</td>
                                </tr>
                                <tr>
                                    <th>Minimal Nilai Untuk Melihat Jawaban</th>
                                    <td>:</td>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-lg-flex align-items-center mb-4 gap-3">
                        ...
                        <div class="ms-auto">
                            <Link :href="`/admin/question-titles/${questionTitle.id}/questions/create`" class="btn btn-primary mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i> Tambah Soal</Link>
                        </div>
                    </div>
                    <table class="table mb-0">
                            ...
                            <tr v-for="(question, index) in questions.data" :key="index">
                                ...
                                <td>
                                    <div v-if="question.type == 1">
                                        ...
                                        <hr>
                                        <ol type="A">
                                            <li v-if="1 <= questionTitle.total_choices" v-html="question.option_1" :class="{ 'text-success fw-bold': question.answer == 1 }"></li>
                                            <li v-if="2 <= questionTitle.total_choices" v-html="question.option_2" :class="{ 'text-success fw-bold': question.answer == 2 }"></li>
                                            <li v-if="3 <= questionTitle.total_choices" v-html="question.option_3" :class="{ 'text-success fw-bold': question.answer == 3 }"></li>
                                            <li v-if="4 <= questionTitle.total_choices" v-html="question.option_4" :class="{ 'text-success fw-bold': question.answer == 4 }"></li>
                                            <li v-if="5 <= questionTitle.total_choices" v-html="question.option_5" :class="{ 'text-success fw-bold': question.answer == 5 }"></li>
                                        </ol>
                                    </div>
                                    <div v-else>
