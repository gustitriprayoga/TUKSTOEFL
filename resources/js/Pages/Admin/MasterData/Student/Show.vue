<template>
    <Head>
        <title>{{ $page.props.app_name }} - Data Siswa</title>
    </Head>
    <!--start page wrapper -->
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-lg-flex align-items-center">
                        <div class="ms-auto">
                            <Link href="/admin/students" class="btn btn-primary mt-2 mt-lg-0">Kembali</Link>
                        </div>
                    </div>
                        ...
                        <table class="table mb-0">
                            <tbody>
                                ...
                                <tr>
                                    <th>Status Akun</th>
                                    <td>:</td>
                                    <td><span class="badge bg-primary">{{ student.user.is_active == 1 ? 'Aktif' : 'Non-Aktif' }}</span></td>
                                </tr>
                                <tr>
                                    <th>Jenis Kelamin</th>
                                    <td>:</td>
                                ...
                                <tr>
                                    <th>Status Member</th>
                                    <td>:</td>
                                    <td>{{ student.is_member == 0 ? 'Non-member' : 'Member' }}</td>
                                </tr>
                                <tr v-if="student.is_member == 0">
                                    <th>Kirim Reminder Member</th>
                                    <td>:</td>
                                    <td><Link :href="`/admin/users/${student.user_id}/member-reminder`" class="btn btn-success btn-sm">Kirim Reminder</Link></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
