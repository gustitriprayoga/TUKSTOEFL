<template>
    <Head>
        <title>{{ $page.props.app_name }} - Data User</title>
    </Head>
    <!--start page wrapper -->
                        ...
                        <table class="table mb-0">
                            <tbody>
                                ...
                                <tr v-if="user.is_active == 0 && user.student">
                                    ...
                                    <td>:</td>
                                    <td><a :href="`https://wa.me/${user.student.phone_number}?text=${encodeURI('hallo, akun anda telah terdaftar di platform kami, berikut link verifikasi untuk aktivasi akun anda.\n\nNama: '+ user.name +'\nEmail: '+ user.email +'\n\n '+ verificationLink + '\n\n*jika link tidak bisa diklik, silakan copy dan pastekan link di browser anda.* \n\nterimakasih telah menjadi bagian dari kami, semoga kami dapat membantu proses belajar anda.')}`">Klik Disini Untuk Mengirim Verifikasi Via WhatsApp</a></td>
                                </tr>
