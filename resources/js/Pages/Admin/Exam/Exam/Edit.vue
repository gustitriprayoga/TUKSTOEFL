<template>
    <Head>
        <title>{{ $page.props.app_name }} - Edit Ujian</title>
    </Head>
    <!--start page wrapper -->
                ...
                <div class="card-body">
                    ...
                    <form @submit.prevent="submit" class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <input type="number" class="form-control" v-model="form.total_tolerance" :class="{ 'is-invalid': errors.total_tolerance }" placeholder="Maksimal Tolerasi">
