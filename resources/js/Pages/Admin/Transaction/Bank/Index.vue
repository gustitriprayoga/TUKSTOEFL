<template>
    <Head>
        <title>{{ $page.props.app_name }} - Data Bank</title>
    </Head>
    <!--start page wrapper -->
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-lg-flex align-items-center mb-4 gap-3">
                        ...
                        <div class="ms-auto">
                            <Link href="/admin/banks/create" class="btn btn-primary mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i> Tambah Bank</Link>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <table class="table mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td align="center" colspan="6" v-if="!banks.data.length">Data Bank kosong</td>
                                </tr>
