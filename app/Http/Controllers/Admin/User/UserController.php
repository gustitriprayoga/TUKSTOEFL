...
class UserController extends Controller
{
    ...
    public function memberReminder($id)
    {
        ...
        $message = "*Mohon dibaca dan dipahami!*\n\n_Hallo, saya admin dari ".env('APP_NAME').", akun anda telah terdaftar di platform kami, berikut akun anda._\n\nNama: ".$user->name."\nEmail: ".$user->email."\n\nsaat ini anda belum mengaktifkan member anda, yuk ambil kesempatan karena ada voucher member gratis.\n\n_terimakasih telah menjadi bagian dari kami, semoga ".env('APP_NAME')." dapat membantu proses belajar anda. aamiin._";
