(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("jquery"), require("vue"), require("trumbowyg/dist/ui/icons.svg"), require("trumbowyg"));
	else if(typeof define === 'function' && define.amd)
		define("VueTrumbowyg", ["jquery", "vue", "trumbowyg/dist/ui/icons.svg", "trumbowyg"], factory);
	else if(typeof exports === 'object')
		exports["VueTrumbowyg"] = factory(require("jquery"), require("vue"), require("trumbowyg/dist/ui/icons.svg"), require("trumbowyg"));
	else
		root["VueTrumbowyg"] = factory(root["jQuery"], root["Vue"], root["trumbowyg/dist/ui/icons.svg"], root["trumbowyg"]);
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "trumbowygPlugin", function() { return /* binding */ trumbowygPlugin; });
...
var external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_ = __webpack_require__(1);

// EXTERNAL MODULE: external "trumbowyg"
var external_trumbowyg_ = __webpack_require__(3);

// EXTERNAL MODULE: external "trumbowyg/dist/ui/icons.svg"
var icons_svg_ = __webpack_require__(2);
...
/* harmony default export */ var component = ({
  ...
  render() {
    return Object(external_commonjs_vue_commonjs2_vue_amd_vue_root_Vue_["h"])('textarea', {
      ref: 'root'
    });
  },
  ...
  mounted() {
    ...
    this.el = external_commonjs_jquery_commonjs2_jquery_amd_jquery_root_jQuery_default()(this.$refs.root); // Init editor with config
    ...
    this.el.trumbowyg('html', this.modelValue); // Watch for further changes
  ...
  methods: {
    ...
    registerEvents() {
      events.forEach(name => {
        this.el.on("".concat(eventPrefix).concat(name), (...args) => {
          this.$emit("".concat(eventPrefix, "-").concat(name), ...args);
        });
      });
    },
